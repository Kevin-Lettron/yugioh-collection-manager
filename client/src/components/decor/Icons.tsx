...
const base = (size: number, className: string, style?: React.CSSProperties) => ({
  width: size,
  height: size,
  className,
  style,
...
export const MillenniumMark = ({ size = 24, className = '', title, style }: IconProps) => (
  <svg viewBox="0 0 32 32" {...base(size, className, style)} aria-hidden={!title} role={title ? 'img' : undefined}>
...
export const CardIcon = ({ size = 24, className = '', style }: IconProps) => (
  <svg viewBox="0 0 24 24" {...base(size, className, style)}>
    <path d="M5 3 H16 L19 6 V21 H5 Z" strokeWidth="1.6" />
    <path d="M8 8 H16 M8 12 H16 M8 16 H13" strokeWidth="1.2" />
  </svg>
);

export const DeckIcon = ({ size = 24, className = '', style }: IconProps) => (
  <svg viewBox="0 0 24 24" {...base(size, className, style)}>
...
export const ScanIcon = ({ size = 24, className = '', style }: IconProps) => (
  <svg viewBox="0 0 24 24" {...base(size, className, style)}>
...
export const SocialIcon = ({ size = 24, className = '', style }: IconProps) => (
  <svg viewBox="0 0 24 24" {...base(size, className, style)}>
...
export const SearchIcon = ({ size = 24, className = '', style }: IconProps) => (
  <svg viewBox="0 0 24 24" {...base(size, className, style)}>
...
export const FilterIcon = ({ size = 24, className = '', style }: IconProps) => (
  <svg viewBox="0 0 24 24" {...base(size, className, style)}>
    <path d="M3 4 H21 L14 12 V20 L10 18 V12 Z" strokeWidth="1.6" />
  </svg>
);

export const AddIcon = ({ size = 24, className = '', style }: IconProps) => (
  <svg viewBox="0 0 24 24" {...base(size, className, style)}>
...
export const SunIcon = ({ size = 24, className = '', style }: IconProps) => (
  <svg viewBox="0 0 24 24" {...base(size, className, style)}>
