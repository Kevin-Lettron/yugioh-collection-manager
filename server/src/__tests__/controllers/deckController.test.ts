...
const mockCardModel = CardModel as jest.Mocked<typeof CardModel>;
...
describe('DeckController', () => {
  ...
  describe('createDeck', () => {
    it('should create a new deck successfully', async () => {
      ...
      expect(mockDeckModel.create).toHaveBeenCalledWith(
        1,
        'My New Deck',
        true,
        true,
  ...
  describe('getUserDecks', () => {
    it('should return paginated user decks', async () => {
      ...
      await DeckController.getUserDecks(
        mockRequest as AuthRequest,
        mockResponse as Response,
        mockNext
      );
  ...
  describe('addCardToDeck', () => {
    it('should add card to deck successfully', async () => {
      ...
      await DeckController.addCardToDeck(
        mockRequest as AuthRequest,
        mockResponse as Response,
        mockNext
      );
  ...
  describe('removeCardFromDeck', () => {
    it('should remove card from deck successfully', async () => {
      ...
      await DeckController.removeCardFromDeck(
        mockRequest as AuthRequest,
        mockResponse as Response,
        mockNext
      );
  ...
  describe('updateCardQuantity', () => {
    it('should update card quantity successfully', async () => {
      ...
      await DeckController.updateCardQuantity(
        mockRequest as AuthRequest,
        mockResponse as Response,
        mockNext
      );
  ...
  describe('validateDeck', () => {
    it('should return valid deck validation', async () => {
      ...
      await DeckController.validateDeck(
  ...
  describe('getPublicDecks', () => {
    ...
    it('should apply filters', async () => {
      ...
      expect(mockDeckModel.searchPublicDecks).toHaveBeenCalledWith(
