...
describe('UserCardModel', () => {
  ...
  describe('addToCollection', () => {
    it('should add a new card to collection', async () => {
      ...
      const result = await UserCardModel.addToCollection(1, 1, 'LOB-005', 'Ultra Rare', 2);

      expect(mockQuery).toHaveBeenCalledWith(
        expect.stringContaining('INSERT INTO user_cards'),
        [1, 1, 'LOB-005', 'Ultra Rare', 2]
      );
    ...
    it('should update quantity on conflict (upsert)', async () => {
      ...
      const result = await UserCardModel.addToCollection(1, 1, 'LOB-005', 'Ultra Rare', 3);
    ...
    it('should default to quantity 1 when not specified', async () => {
      ...
      const result = await UserCardModel.addToCollection(1, 1, 'LOB-005', 'Ultra Rare');

      expect(mockQuery).toHaveBeenCalledWith(
        expect.any(String),
        [1, 1, 'LOB-005', 'Ultra Rare', 1]
      );
    });
    ...
    it('should throw error on database failure', async () => {
      ...
      await expect(
        UserCardModel.addToCollection(1, 1, 'LOB-005', 'Ultra Rare')
  ...
  describe('getUserCollection', () => {
    it('should return paginated collection', async () => {
      ...
      const result = await UserCardModel.getUserCollection(1, { page: 1, limit: 50 });
    ...
    it('should apply search filter', async () => {
      ...
      await UserCardModel.getUserCollection(1, { search: 'Dark Magician' });

      expect(mockQuery).toHaveBeenCalledWith(
        expect.stringContaining('ILIKE'),
        expect.arrayContaining(['%Dark Magician%'])
      );
    });
    ...
    it('should apply type filter', async () => {
      ...
      await UserCardModel.getUserCollection(1, { type: 'Normal Monster' });

      expect(mockQuery).toHaveBeenCalledWith(
        expect.stringContaining('c.type = $'),
    ...
    it('should apply frame_type filter', async () => {
      ...
      await UserCardModel.getUserCollection(1, { frame_type: 'effect' });
    ...
    it('should apply rarity filter', async () => {
      ...
      await UserCardModel.getUserCollection(1, { rarity: 'Ultra Rare' });

      expect(mockQuery).toHaveBeenCalledWith(
        expect.stringContaining('uc.rarity = $'),
        expect.arrayContaining(['Ultra Rare'])
      );
    });
    ...
    it('should apply level filter', async () => {
      ...
      await UserCardModel.getUserCollection(1, { level: 7 });

      expect(mockQuery).toHaveBeenCalledWith(
        expect.stringContaining('c.level = $'),
    ...
    it('should apply ATK range filters', async () => {
      ...
      await UserCardModel.getUserCollection(1, { min_atk: 2000, max_atk: 3000 });
    ...
    it('should apply DEF range filters', async () => {
      ...
      await UserCardModel.getUserCollection(1, { min_def: 1500, max_def: 2500 });
    ...
    it('should apply attribute filter', async () => {
      ...
      await UserCardModel.getUserCollection(1, { attribute: 'DARK' });
    ...
    it('should apply race filter', async () => {
      ...
      await UserCardModel.getUserCollection(1, { race: 'Spellcaster' });
    ...
    it('should apply multiple filters together', async () => {
      ...
      await UserCardModel.getUserCollection(1, {
        type: 'Normal Monster',
        attribute: 'DARK',
        level: 7,
        rarity: 'Ultra Rare',
    ...
    it('should return empty collection when user has no cards', async () => {
      ...
      const result = await UserCardModel.getUserCollection(1);
  ...
  describe('getUserCard', () => {
    it('should return user card with card details', async () => {
      ...
      const result = await UserCardModel.getUserCard(1, 1);

      expect(mockQuery).toHaveBeenCalledWith(
        expect.stringContaining('WHERE uc.user_id = $1 AND uc.card_id = $2'),
        [1, 1]
      );
    ...
    it('should return null when card not in collection', async () => {
      ...
      const result = await UserCardModel.getUserCard(1, 999);
  ...
  describe('hasCard', () => {
    it('should return true when user has card', async () => {
      ...
      const result = await UserCardModel.hasCard(1, 1);
    ...
    it('should return false when user does not have card', async () => {
      ...
      const result = await UserCardModel.hasCard(1, 999);
  ...
  describe('getTotalQuantity', () => {
    it('should return total quantity across all rarities', async () => {
      ...
      const result = await UserCardModel.getTotalQuantity(1, 1);

      expect(mockQuery).toHaveBeenCalledWith(
        expect.stringContaining('SUM(quantity)'),
        [1, 1]
      );
    ...
    it('should return 0 when card not in collection', async () => {
      ...
      const result = await UserCardModel.getTotalQuantity(1, 999);
  ...
  describe('updateQuantity', () => {
    it('should update quantity successfully', async () => {
      ...
      const result = await UserCardModel.updateQuantity(1, 1, 5);

      expect(mockQuery).toHaveBeenCalledWith(
        expect.stringContaining('UPDATE user_cards'),
        [5, 1, 1]
      );
      expect(result?.quantity).toBe(5);
    });
    ...
    it('should delete card when quantity is 0', async () => {
      ...
      const result = await UserCardModel.updateQuantity(1, 1, 0);

      expect(mockQuery).toHaveBeenCalledWith(
        expect.stringContaining('DELETE FROM user_cards'),
        [1, 1]
      );
      expect(result).toBeNull();
    });
    ...
    it('should delete card when quantity is negative', async () => {
      ...
      const result = await UserCardModel.updateQuantity(1, 1, -1);
    ...
    it('should return null when card not found', async () => {
      ...
      const result = await UserCardModel.updateQuantity(1, 999, 5);
  ...
  describe('removeFromCollection', () => {
    it('should remove card successfully', async () => {
      ...
      const result = await UserCardModel.removeFromCollection(1, 1);
    ...
    it('should return false when card not found', async () => {
      ...
      const result = await UserCardModel.removeFromCollection(1, 999);
    ...
    it('should return false when user does not own the card', async () => {
      ...
      const result = await UserCardModel.removeFromCollection(999, 1);
