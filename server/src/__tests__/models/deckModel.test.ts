...
const mockIsExtraDeckCard = YGOProDeckService.isExtraDeckCard as jest.MockedFunction<typeof YGOProDeckService.isExtraDeckCard>;
const mockGetBanlistLimit = YGOProDeckService.getBanlistLimit as jest.MockedFunction<typeof YGOProDeckService.getBanlistLimit>;
...
describe('DeckModel', () => {
  ...
  const mockSemiLimitedCard: Card = {
    ...mockCard,
    id: 5,
    card_id: '34567890',
  ...
  describe('create', () => {
    it('should create a new deck successfully', async () => {
      ...
      const result = await DeckModel.create(1, 'My Test Deck', true, true);

      expect(mockQuery).toHaveBeenCalledWith(
        expect.stringContaining('INSERT INTO decks'),
        [1, 'My Test Deck', true, true, null]
      );
    ...
    it('should create deck with custom settings', async () => {
      ...
      const result = await DeckModel.create(1, 'Private Deck', false, false, 'http://cover.jpg');

      expect(mockQuery).toHaveBeenCalledWith(
        expect.stringContaining('INSERT INTO decks'),
        [1, 'Private Deck', false, false, 'http://cover.jpg']
      );
    });
    ...
    it('should throw error on database failure', async () => {
      ...
      await expect(DeckModel.create(1, 'Test Deck')).rejects.toThrow('Database error');
    });
  });
  ...
  describe('findById', () => {
    it('should return deck with full details when found', async () => {
      ...
      const result = await DeckModel.findById(1);
    ...
    it('should return null when deck not found', async () => {
      ...
      const result = await DeckModel.findById(9999);
    ...
    it('should include user reaction when requestingUserId provided', async () => {
      ...
      const result = await DeckModel.findById(1, 2);
  ...
  describe('getUserDecks', () => {
    it('should return paginated user decks', async () => {
      ...
      const result = await DeckModel.getUserDecks(1, { page: 1, limit: 20 });
    ...
    it('should apply search filter', async () => {
      ...
      await DeckModel.getUserDecks(1, { search: 'Test' });
    ...
    it('should filter by respect_banlist', async () => {
      ...
      await DeckModel.getUserDecks(1, { respect_banlist: true });

      expect(mockQuery).toHaveBeenCalledWith(
        expect.stringContaining('respect_banlist'),
  ...
  describe('update', () => {
    it('should update deck name', async () => {
      ...
      const result = await DeckModel.update(1, 1, { name: 'Updated Name' });

      expect(mockQuery).toHaveBeenCalledWith(
        expect.stringContaining('UPDATE decks'),
        expect.arrayContaining(['Updated Name', 1, 1])
      );
    });
    ...
    it('should return null when deck not found or unauthorized', async () => {
      ...
      const result = await DeckModel.update(999, 1, { name: 'Test' });
  ...
  describe('delete', () => {
    it('should delete deck successfully', async () => {
      ...
      const result = await DeckModel.delete(1, 1);
    ...
    it('should return false when deck not found or unauthorized', async () => {
      ...
      const result = await DeckModel.delete(999, 1);
  ...
  describe('addCard', () => {
    ...
    it('should add card to main deck successfully', async () => {
      ...
      const result = await DeckModel.addCard(1, 1, 1, 1, false, mockCard);
    ...
    it('should reject adding main deck card to extra deck', async () => {
      ...
      const result = await DeckModel.addCard(1, 1, 1, 1, true, mockCard);
    ...
    it('should reject adding extra deck card to main deck', async () => {
      ...
      const result = await DeckModel.addCard(1, 1, 2, 1, false, mockExtraDeckCard);
    ...
    it('should reject when extra deck exceeds 15 cards', async () => {
      ...
      const result = await DeckModel.addCard(1, 1, 2, 1, true, mockExtraDeckCard);
    ...
    it('should reject Forbidden card when respecting banlist', async () => {
      ...
      const result = await DeckModel.addCard(1, 1, 3, 1, false, mockForbiddenCard);
    ...
    it('should reject more than 1 Limited card when respecting banlist', async () => {
      ...
      const result = await DeckModel.addCard(1, 1, 4, 1, false, mockLimitedCard);
    ...
    it('should reject more than 2 Semi-Limited cards when respecting banlist', async () => {
      ...
      const result = await DeckModel.addCard(1, 1, 5, 1, false, mockSemiLimitedCard);
  ...
  describe('removeCard', () => {
    it('should remove card from deck successfully', async () => {
      ...
      const result = await DeckModel.removeCard(1, 1, 1);
    ...
    it('should return false when card not found', async () => {
      ...
      const result = await DeckModel.removeCard(1, 1, 999);
  ...
  describe('validateDeck', () => {
    it('should validate deck with correct card counts', async () => {
      ...
      const result = await DeckModel.validateDeck(1);
  ...
  describe('searchPublicDecks', () => {
    it('should return only public decks', async () => {
      ...
      const result = await DeckModel.searchPublicDecks({});
    ...
    it('should filter by user_id', async () => {
      ...
      await DeckModel.searchPublicDecks({ user_id: 1 });
