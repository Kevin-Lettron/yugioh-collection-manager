...
describe('CardModel', () => {
    ...
    describe('upsert', () => {
        it('should create a new card successfully', async () => {
            ...
            const result = await cardModel_1.CardModel.upsert(cardData);
            expect(mockQuery).toHaveBeenCalledWith(expect.stringContaining('INSERT INTO cards'), expect.arrayContaining([cardData.card_id, cardData.name]));
        ...
        it('should update existing card on conflict', async () => {
            ...
            const result = await cardModel_1.CardModel.upsert(cardData);
            expect(mockQuery).toHaveBeenCalledWith(expect.stringContaining('ON CONFLICT (card_id) DO UPDATE'), expect.any(Array));
        ...
        it('should handle JSON serialization for complex fields', async () => {
            ...
            await cardModel_1.CardModel.upsert(cardData);
    ...
    describe('findById', () => {
        it('should return card when found by database ID', async () => {
            ...
            const result = await cardModel_1.CardModel.findById(1);
        ...
        it('should return null when card not found', async () => {
            ...
            const result = await cardModel_1.CardModel.findById(9999);
    ...
    describe('findByCardId', () => {
        it('should return card when found by YGOProDeck card_id', async () => {
            ...
            const result = await cardModel_1.CardModel.findByCardId('46986414');
            expect(mockQuery).toHaveBeenCalledWith(expect.stringContaining('WHERE card_id = $1'), ['46986414']);
        ...
        it('should return null when card_id not found', async () => {
            ...
            const result = await cardModel_1.CardModel.findByCardId('99999999');
            expect(result).toBeNull();
        });
    });
    describe('findByName', () => {
        it('should return card when found by name (case insensitive)', async () => {
            ...
            const result = await cardModel_1.CardModel.findByName('dark magician');
            expect(mockQuery).toHaveBeenCalledWith(expect.stringContaining('ILIKE'), ['dark magician']);
            expect(result?.name).toBe('Dark Magician');
        });
        it('should return null when name not found', async () => {
            ...
            const result = await cardModel_1.CardModel.findByName('NonExistent Card');
            expect(result).toBeNull();
        });
    });
    describe('search', () => {
        it('should search cards by term', async () => {
            ...
            const result = await cardModel_1.CardModel.search('Dragon');
        ...
        it('should apply type filter', async () => {
            ...
            const result = await cardModel_1.CardModel.search('', { type: 'Normal Monster' });
            expect(mockQuery).toHaveBeenCalledWith(expect.stringContaining('type = $'), expect.arrayContaining(['Normal Monster']));
        ...
        it('should apply frame_type filter', async () => {
            ...
            const result = await cardModel_1.CardModel.search('', { frame_type: 'synchro' });
            expect(mockQuery).toHaveBeenCalledWith(expect.stringContaining('frame_type = $'), expect.arrayContaining(['synchro']));
        });
        it('should apply level filter', async () => {
            ...
            const result = await cardModel_1.CardModel.search('', { level: 7 });
            expect(mockQuery).toHaveBeenCalledWith(expect.stringContaining('level = $'), expect.arrayContaining([7]));
        });
        it('should apply attribute filter', async () => {
            ...
            const result = await cardModel_1.CardModel.search('', { attribute: 'DARK' });
        ...
        it('should apply race filter', async () => {
            ...
            const result = await cardModel_1.CardModel.search('', { race: 'Spellcaster' });
        ...
        it('should apply ATK range filters', async () => {
            ...
            const result = await cardModel_1.CardModel.search('', { min_atk: 2000, max_atk: 3000 });
        ...
        it('should apply DEF range filters', async () => {
            ...
            const result = await cardModel_1.CardModel.search('', { min_def: 1500, max_def: 2500 });
            expect(mockQuery).toHaveBeenCalledWith(expect.stringContaining('def >= $'), expect.arrayContaining([1500]));
            expect(mockQuery).toHaveBeenCalledWith(expect.stringContaining('def <= $'), expect.arrayContaining([2500]));
        });
        it('should apply multiple filters together', async () => {
            ...
            const result = await cardModel_1.CardModel.search('Magician', {
                type: 'Normal Monster',
                attribute: 'DARK',
                level: 7,
            });
            expect(mockQuery).toHaveBeenCalledWith(expect.stringContaining('type = $'), expect.any(Array));
        });
        it('should paginate results with limit and offset', async () => {
            ...
            const result = await cardModel_1.CardModel.search('', {}, 10, 20);
            expect(mockQuery).toHaveBeenLastCalledWith(expect.stringContaining('LIMIT'), expect.arrayContaining([10, 20]));
        ...
        it('should return empty results when no matches', async () => {
            ...
            const result = await cardModel_1.CardModel.search('xyznonexistent');
        ...
        it('should handle empty search term', async () => {
            ...
            const result = await cardModel_1.CardModel.search('');
