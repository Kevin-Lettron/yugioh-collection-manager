...
const mockFollowModel = followModel_1.FollowModel;
const mockWishlistModel = wishlistModel_1.WishlistModel;
const mockUserModel = userModel_1.UserModel;
const mockDeckModel = deckModel_1.DeckModel;
const mockNotificationModel = notificationModel_1.NotificationModel;
describe('SocialController', () => {
    ...
    describe('followUser', () => {
        it('should follow a user successfully', async () => {
            ...
            await socialController_1.SocialController.followUser(mockRequest, mockResponse, mockNext);
    ...
    describe('unfollowUser', () => {
        it('should unfollow a user successfully', async () => {
            ...
            await socialController_1.SocialController.unfollowUser(mockRequest, mockResponse, mockNext);
    ...
    describe('getFollowers', () => {
        it('should return paginated followers list', async () => {
            ...
            await socialController_1.SocialController.getFollowers(mockRequest, mockResponse, mockNext);
    ...
    describe('getFollowing', () => {
        it('should return paginated following list', async () => {
            ...
            await socialController_1.SocialController.getFollowing(mockRequest, mockResponse, mockNext);
    ...
    describe('addToWishlist', () => {
        it('should add public deck to wishlist successfully', async () => {
            ...
            await socialController_1.SocialController.addToWishlist(mockRequest, mockResponse, mockNext);
    ...
    describe('removeFromWishlist', () => {
        it('should remove deck from wishlist successfully', async () => {
            ...
            await socialController_1.SocialController.removeFromWishlist(mockRequest, mockResponse, mockNext);
    ...
    describe('getWishlist', () => {
        it('should return paginated wishlist', async () => {
            ...
            await socialController_1.SocialController.getWishlist(mockRequest, mockResponse, mockNext);
